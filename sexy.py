...
async def start_sexy():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await idk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await idk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await idk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await idk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await adk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await adk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await adk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await adk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await edk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await edk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await edk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await edk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sid(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sid(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sid(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await sid(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aan(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aan(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aan(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aan(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ake(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ake(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ake(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await ake(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eel(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eel(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eel(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eel(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await khu(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await khu(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await khu(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await khu(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shi(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shi(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shi(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await shi(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await dav(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await dav(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await dav(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await dav(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await raj(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await raj(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await raj(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await raj(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await put(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await put(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await put(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await put(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eag(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eag(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eag(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await eag(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await gle(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await gle(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await gle(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await gle(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wal(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wal(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wal(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await wal(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await aaa(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await boy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await boy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await boy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
            await boy(functions.channels.JoinChannelRequest(channel="@Sexy_Army"))
...
print(text)
print("")
print("👅𝙎𝙀𝙓𝙔 𝙎𝙋𝘼𝙈 𝘽𝙊𝙏 𝙍𝙀𝘼𝘿𝙔 𝙏𝙊 𝙁𝙐𝘾𝙆\n𝙅𝙤𝙞𝙣 @𝙎𝙀𝙓𝙔_𝘼𝙍𝙈𝙔 𝙁𝙊𝙍 𝙐𝙋𝘿𝘼𝙏𝙀𝙎👅")
